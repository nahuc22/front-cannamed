...
const HERO_BG = '/src/assets/images/cannamed_hero_bg_uploaded_1780361509856.png';
const PARALLAX_LEAF = '/src/assets/images/cannamed_isolated_leaf_1780361525104.png';
...
export default function App() {
  ...
  return (
    <div id="cannamed-root" ref={containerRef} className="relative z-10 w-full min-h-screen font-sans bg-[#030303] selection:bg-cannamed-600 selection:text-white">
      ...
      {/* THREE-DIMENSIONAL FLOATING TYPOGRAPHY BACKGROUND MASK LAYER */}
      <div className="absolute inset-0 z-[2] pointer-events-none overflow-hidden select-none">
        <div className="sticky top-1/4 left-10 md:left-24 w-full flex flex-col justify-center items-start leading-[0.8] opacity-15">
          ...
          <p className="mt-8 text-cannamed-400 font-mono text-xs max-w-[280px] leading-relaxed uppercase tracking-[0.25em]">
            ASOCIACIÓN FITOBOTÁNICA // EST. 2024
          </p>
        </div>
      </div>
      ...
      <div className="w-full relative z-10 grid grid-cols-12 min-h-screen">
        ...
        <div className="col-span-1 border-r border-white/10 hidden lg:flex flex-col justify-between items-center py-10 bg-[#040404]/30 backdrop-blur-md h-screen sticky top-0 z-40 select-none">
          <div className="text-[11px] font-mono tracking-[0.5rem] uppercase [writing-mode:vertical-lr] rotate-180 font-semibold text-cannamed-500 hover:text-[#1ca233] transition-colors">
            CANNAMED · SOCIEDAD FITOMEDICINAL
          </div>
          <div className="space-y-6 flex flex-col items-center">
            <div className="w-px h-16 bg-white/20"></div>
            <div className="text-[9px] font-mono opacity-50 uppercase tracking-[0.3em] [writing-mode:vertical-lr] rotate-180 text-zinc-400">
              DESDE 2024
            </div>
          </div>
        </div>
            ...
            <section id="alianza" className="relative z-30 bg-[#060606] py-24 px-6 md:px-12 border-y border-white/[0.06]">
              <div className="w-full max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="bg-[#090909] hover:bg-[#0d0d0d] p-8 rounded-2xl border border-white/[0.06] hover:border-cannamed-500/20 shadow-xl transition-all group">
                    <div className="w-12 h-12 rounded-xl bg-cannamed-950/50 flex items-center justify-center border border-cannamed-900/30 mb-6 group-hover:scale-105 transition-transform duration-300">
                      <Heart className="w-5 h-5 text-cannamed-600" />
                    </div>
                  ...
                  <div className="bg-[#090909] hover:bg-[#0d0d0d] p-8 rounded-2xl border border-white/[0.06] hover:border-cannamed-500/20 shadow-xl transition-all group">
                    <div className="w-12 h-12 rounded-xl bg-cannamed-950/50 flex items-center justify-center border border-cannamed-900/30 mb-6 group-hover:scale-105 transition-transform duration-300">
                      <Beaker className="w-5 h-5 text-cannamed-600" />
                    </div>
                  ...
                  <div className="bg-[#090909] hover:bg-[#0d0d0d] p-8 rounded-2xl border border-white/[0.06] hover:border-cannamed-500/20 shadow-xl transition-all group">
                    <div className="w-12 h-12 rounded-xl bg-cannamed-950/50 flex items-center justify-center border border-cannamed-900/30 mb-6 group-hover:scale-105 transition-transform duration-300">
                      <ShieldCheck className="w-5 h-5 text-cannamed-600" />
                    </div>
              ...
              <div className="w-full max-w-4xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 aspect-auto md:aspect-[4/3] w-full relative bg-zinc-950 p-3 md:p-4 rounded-3xl border border-white/5 shadow-2xl overflow-hidden">
                  ...
                  <FlipCard
                    ...
                    backImage="https://images.unsplash.com/photo-1607619056574-7b8f30413636?auto=format&fit=crop&w=600&q=80"
                  ...
                  <FlipCard
                    ...
                    backImage="https://images.unsplash.com/photo-1579154204601-01588f351167?auto=format&fit=crop&w=600&q=80"
                  ...
                  <FlipCard
                    ...
                    backImage="https://images.unsplash.com/photo-1601314002592-b8730b2685d5?auto=format&fit=crop&w=600&q=80"
        ...
        {/* SECTION: FAQ & GARANTÍA DE LEGALIDAD */}
        <section id="faq" className="relative z-30 bg-[#060606] py-24 px-6 border-y border-zinc-900">
          <div className="w-full max-w-4xl mx-auto">
            
            <div className="text-center max-w-xl mx-auto mb-16">
              <p className="font-mono text-xs uppercase tracking-widest text-[#1ca233] mb-3 font-semibold">// Tu Salud en un Entorno Confiable</p>
              ...
              <p className="font-sans text-sm text-zinc-400 mt-2 leading-relaxed">
                Entendemos que el marco regulatorio del cannabis medicinal puede ser complejo. Aquí resolvemos tus consultas principales de manera clara y directa.
              </p>
            </div>

            {/* Accent FAQ accordion list */}
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-full flex items-center justify-between p-6 cursor-pointer text-left focus:outline-none focus:ring-1 focus:ring-cannamed-500 rounded-xl"
                    >
                      <span className="font-serif text-lg md:text-xl font-medium text-zinc-100 pr-4">
                        {faq.question}
                      </span>
                      <ChevronDown className={`w-5 h-5 text-cannamed-600 shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} />
                    </button>
                    
                    <AnimatePresence id={`faq-accordion-anim-${index}`}>
                      {isOpen && (
                        <motion.div
                        ...
                        >
                          <div id={`faq-answer-inner-${index}`} className="px-6 pb-6 border-t border-zinc-900 text-zinc-400 font-sans text-sm md:text-base leading-relaxed pt-4">
                            {faq.answer}
                          </div>
                        </motion.div>
                      )}
            ...
            {/* Quick legal warning banner conforming with medical cannabis rules */}
            <div className="mt-12 p-6 rounded-xl bg-zinc-950 border border-zinc-900 flex items-start gap-4">
              ...
              <div>
                <h4 className="font-mono text-xs uppercase tracking-wider text-zinc-300 font-semibold">Aviso Importante de Salud Pública</h4>
                <p className="font-sans text-xs text-zinc-500 mt-1 leading-relaxed">
                  Cannamed no promueve el consumo recreativo de cannabis ni la venta abierta al público general. Operamos de manera estrictamente medicinal proveyendo acompañamiento exclusivamente a afiliados legalmente autorizados con recetas fitoterapéuticas validadas por profesionales de la salud.
                </p>
              </div>
            </div>
